...
procedure Tfrm_cad_cidades.btn_CancelarClick(Sender: TObject);
begin
  ds_cad_cidades.DataSet.cancel;
end;
...
procedure Tfrm_cad_cidades.btn_ExcluirClick(Sender: TObject);
begin
   ds_cad_cidades.DataSet.delete;
end;
